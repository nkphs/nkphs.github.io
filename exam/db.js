...
if(examDate != null){
    $("#tab_report").append("<tr id=tr" + examID + examClass + examSubject + "><td>" + examName + "</td><td>" + examDate + "</td><td>" + examClass + "</td><td><input type=\"text\" id=\"downloadable" + examID + examClass + examSubject + "\" value=\"" + questionDownloadable + "\"></td><td><input type=\"text\" id=\"examActivation" + examID + examClass + examSubject + "\" value=\"" + examActivation + "\"></td><td>" + examSubject + "</td><td><input type=\"text\" id=\"examTime" + examID + examClass + examSubject + "\" value=\"" + examTime + "\"></td><td><input type=\"text\" id=\"examFullMarks" + examID + examClass + examSubject + "\" value=\"" + examFullMarks + "\"></td><td>" + examInstruction + "</td><td>" + examType + "</td><td>" + examLink + "</td><td><input type=\"text\" id=\"examPassCode" + examID + examClass + examSubject + "\" value=\"" + examPassCode + "\"></td><td><input type=\"text\" id=\"examRoom" + examID + examClass + examSubject + "\" value=\"" + examRoom + "\"></td><td><input type=\"text\" id=\"banned" + examID + examClass + examSubject + "\" value=\"" + banned + "\"></td><td>" + imgbtn + "</td><td>" + updbtn + "</td><td>" + removebtn + "</td></tr>");
}
